    ...
    <>
      ...
      <Box m="2rem 2rem">
        <Grid container rowSpacing={6} columnSpacing={4} >
          <Grid item xs={6} gap={4} display="flex" alignItems="center" whiteSpace='nowrap'>
              ...
              </Typography>
              {
                ...
                <Box display='flex' gap={2}>
                  <Box display='flex' gap={2}>
                    ...
                    <Typography variant='h10' fontWeight={600}>{user?.followers.length}</Typography>
                  </Box>
                  |
                  <Box display='flex' gap={2}>
                    <Typography variant='h10'>Following</Typography>
                    <Typography variant='h10' fontWeight={600}>{user?.following.length}</Typography>
                  </Box>
                </Box>
              }
            </Box>
