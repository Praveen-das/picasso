import {
    Box, Grid, Typography, Modal, Button
} from '@mui/material'
                        ...
                        success ?
                            ...
                            <>
                                <Grid style={leftBoxStyle} className='login_left' item width={{ xs: '300px', md: '500px' }}>
                                    <div style={{ opacity: window ? 1 : 0 }} className='signup_hero'>
                                        <Grid item xs={12}>
                                        ...
                                        <button onClick={() => setWindow(!window)} className='signup_btn' sx={{ background: 'white' }} type='submit' variant='contained'><RightIcon sx={{ width: '1.3em', height: '1.3em' }} /></button>
                                    </div>
                                    <div style={{ opacity: window ? 0 : 1 }} className='signin_hero'>
                                        <Grid item xs={12}>
                                        ...
                                        <button onClick={() => setWindow(!window)} className='signup_btn' sx={{ background: 'white' }} type='submit' variant='contained'><LeftIcon sx={{ width: '1.3em', height: '1.3em' }} /></button>
                                    </div>
                                </Grid>
