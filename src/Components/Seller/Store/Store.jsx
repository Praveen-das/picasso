                    ...
                    >
                        ...
                        >
                            ...
                            <Box display='flex' gap={2}>
                                <Box display='flex' gap={2}>
                                    <Typography variant='h10' fontWeight={600}>{person?.product?.length}</Typography>
                                    <Typography variant='h10'>Artworks</Typography>
                                </Box>
                                -
                                <Box display='flex' gap={2}>
                                    <Typography variant='h10' fontWeight={600}>{person?.followers?.length}</Typography>
