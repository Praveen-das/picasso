...
import { accountDetailsSchema } from '../../Schema/YupSchema'
import { createLinkedAccount, getLinkedAccounts } from '../../lib/rzp'
...
function SellerOnbording({ active, callback, data: email }) {
  const ref = useRef()
...
function OnboardingConfirmation({ active, callback }) {
  const ref = useRef()
  const queryClient = useQueryClient()

  function handleSubmit(payload, { setSubmitting, setFieldError }) {
          ...
          {({ isSubmitting, errors, touched, handleChange, handleBlur, setFieldError }) => (
            <Form>
              ...
              >
                ...
                <Box>
                  <a className='razorpay_logo' href="https://razorpay.com/" target="_blank">
